...
class FeaturedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create featured" do
    assert_difference('Featured.count') do
      post featureds_url, params: { featured: { body: @featured.body, f_title: @featured.f_title } }
    end
  ...
  test "should update featured" do
    patch featured_url(@featured), params: { featured: { body: @featured.body, f_title: @featured.f_title } }
