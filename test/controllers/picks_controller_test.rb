...
class PicksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pick" do
    assert_difference('Pick.count') do
      post picks_url, params: { pick: { category_id: @pick.category_id, p_body: @pick.p_body, p_title: @pick.p_title } }
    end
  ...
  test "should update pick" do
    patch pick_url(@pick), params: { pick: { category_id: @pick.category_id, p_body: @pick.p_body, p_title: @pick.p_title } }
